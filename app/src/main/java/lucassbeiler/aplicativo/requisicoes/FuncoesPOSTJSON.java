...
public class FuncoesPOSTJSON extends AsyncTask<String, String, String> {
    @Override
    protected String doInBackground(String... parametros) {
        ...
        Request requisicao = new Request.Builder().url(rota).addHeader("Authorization", "Bearer " + token).post(corpoRequisicao).build();
